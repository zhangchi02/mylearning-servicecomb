...
@RestSchema(schemaId = "springController54")
@RequestMapping(value = "/spring/v0")
public class SpringController54 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello54", method = RequestMethod.GET)
  public String sayHello54(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController123")
@RequestMapping(value = "/spring/v0")
public class SpringController123 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello123", method = RequestMethod.GET)
  public String sayHello123(@RequestParam(name = "name") String name) {

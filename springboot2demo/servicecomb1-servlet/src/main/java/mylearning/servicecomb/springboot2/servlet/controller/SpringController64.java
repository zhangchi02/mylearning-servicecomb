...
@RestSchema(schemaId = "springController64")
@RequestMapping(value = "/spring/v0")
public class SpringController64 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello64", method = RequestMethod.GET)
  public String sayHello64(@RequestParam(name = "name") String name) {

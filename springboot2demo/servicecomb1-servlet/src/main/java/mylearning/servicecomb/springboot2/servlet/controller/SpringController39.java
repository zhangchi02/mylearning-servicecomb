...
@RestSchema(schemaId = "springController39")
@RequestMapping(value = "/spring/v0")
public class SpringController39 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello39", method = RequestMethod.GET)
  public String sayHello39(@RequestParam(name = "name") String name) {

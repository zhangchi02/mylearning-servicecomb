...
@RestSchema(schemaId = "springController119")
@RequestMapping(value = "/spring/v0")
public class SpringController119 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello119", method = RequestMethod.GET)
  public String sayHello119(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController89")
@RequestMapping(value = "/spring/v0")
public class SpringController89 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello89", method = RequestMethod.GET)
  public String sayHello89(@RequestParam(name = "name") String name) {

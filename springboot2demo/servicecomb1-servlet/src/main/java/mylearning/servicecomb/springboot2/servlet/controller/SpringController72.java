...
@RestSchema(schemaId = "springController72")
@RequestMapping(value = "/spring/v0")
public class SpringController72 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello72", method = RequestMethod.GET)
  public String sayHello72(@RequestParam(name = "name") String name) {

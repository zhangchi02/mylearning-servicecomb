...
@RestSchema(schemaId = "springController117")
@RequestMapping(value = "/spring/v0")
public class SpringController117 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello117", method = RequestMethod.GET)
  public String sayHello117(@RequestParam(name = "name") String name) {

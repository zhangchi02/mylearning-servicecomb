...
@RestSchema(schemaId = "springController22")
@RequestMapping(value = "/spring/v0")
public class SpringController22 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello22", method = RequestMethod.GET)
  public String sayHello22(@RequestParam(name = "name") String name) {

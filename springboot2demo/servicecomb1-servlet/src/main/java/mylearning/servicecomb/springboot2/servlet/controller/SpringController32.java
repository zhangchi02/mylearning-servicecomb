...
@RestSchema(schemaId = "springController32")
@RequestMapping(value = "/spring/v0")
public class SpringController32 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello32", method = RequestMethod.GET)
  public String sayHello32(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController94")
@RequestMapping(value = "/spring/v0")
public class SpringController94 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello94", method = RequestMethod.GET)
  public String sayHello94(@RequestParam(name = "name") String name) {

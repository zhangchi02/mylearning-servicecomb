...
@RestSchema(schemaId = "springController131")
@RequestMapping(value = "/spring/v0")
public class SpringController131 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello131", method = RequestMethod.GET)
  public String sayHello131(@RequestParam(name = "name") String name) {

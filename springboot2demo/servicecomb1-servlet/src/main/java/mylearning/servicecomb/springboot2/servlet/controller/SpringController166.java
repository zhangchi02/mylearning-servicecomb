...
@RestSchema(schemaId = "springController166")
@RequestMapping(value = "/spring/v0")
public class SpringController166 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello166", method = RequestMethod.GET)
  public String sayHello166(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController57")
@RequestMapping(value = "/spring/v0")
public class SpringController57 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello57", method = RequestMethod.GET)
  public String sayHello57(@RequestParam(name = "name") String name) {

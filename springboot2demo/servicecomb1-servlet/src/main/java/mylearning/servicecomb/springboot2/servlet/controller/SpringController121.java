...
@RestSchema(schemaId = "springController121")
@RequestMapping(value = "/spring/v0")
public class SpringController121 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello121", method = RequestMethod.GET)
  public String sayHello121(@RequestParam(name = "name") String name) {

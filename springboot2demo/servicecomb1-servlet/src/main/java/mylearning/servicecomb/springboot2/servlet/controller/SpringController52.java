...
@RestSchema(schemaId = "springController52")
@RequestMapping(value = "/spring/v0")
public class SpringController52 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello52", method = RequestMethod.GET)
  public String sayHello52(@RequestParam(name = "name") String name) {

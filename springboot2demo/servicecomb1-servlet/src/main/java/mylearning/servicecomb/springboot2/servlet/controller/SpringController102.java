...
@RestSchema(schemaId = "springController102")
@RequestMapping(value = "/spring/v0")
public class SpringController102 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello102", method = RequestMethod.GET)
  public String sayHello102(@RequestParam(name = "name") String name) {

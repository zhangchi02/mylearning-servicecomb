...
@RestSchema(schemaId = "springController41")
@RequestMapping(value = "/spring/v0")
public class SpringController41 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello41", method = RequestMethod.GET)
  public String sayHello41(@RequestParam(name = "name") String name) {

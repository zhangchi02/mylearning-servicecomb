...
@RestSchema(schemaId = "springController82")
@RequestMapping(value = "/spring/v0")
public class SpringController82 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello82", method = RequestMethod.GET)
  public String sayHello82(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController49")
@RequestMapping(value = "/spring/v0")
public class SpringController49 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello49", method = RequestMethod.GET)
  public String sayHello49(@RequestParam(name = "name") String name) {

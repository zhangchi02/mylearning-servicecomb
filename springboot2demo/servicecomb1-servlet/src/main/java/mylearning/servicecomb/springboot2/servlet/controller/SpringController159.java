...
@RestSchema(schemaId = "springController159")
@RequestMapping(value = "/spring/v0")
public class SpringController159 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello159", method = RequestMethod.GET)
  public String sayHello159(@RequestParam(name = "name") String name) {

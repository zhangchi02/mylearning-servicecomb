...
@RestSchema(schemaId = "springController26")
@RequestMapping(value = "/spring/v0")
public class SpringController26 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello26", method = RequestMethod.GET)
  public String sayHello26(@RequestParam(name = "name") String name) {

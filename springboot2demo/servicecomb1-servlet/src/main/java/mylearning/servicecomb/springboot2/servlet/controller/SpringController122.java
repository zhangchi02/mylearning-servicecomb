...
@RestSchema(schemaId = "springController122")
@RequestMapping(value = "/spring/v0")
public class SpringController122 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello122", method = RequestMethod.GET)
  public String sayHello122(@RequestParam(name = "name") String name) {

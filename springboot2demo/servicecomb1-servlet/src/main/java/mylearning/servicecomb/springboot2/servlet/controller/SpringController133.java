...
@RestSchema(schemaId = "springController133")
@RequestMapping(value = "/spring/v0")
public class SpringController133 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello133", method = RequestMethod.GET)
  public String sayHello133(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController76")
@RequestMapping(value = "/spring/v0")
public class SpringController76 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello76", method = RequestMethod.GET)
  public String sayHello76(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController152")
@RequestMapping(value = "/spring/v0")
public class SpringController152 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello152", method = RequestMethod.GET)
  public String sayHello152(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController175")
@RequestMapping(value = "/spring/v0")
public class SpringController175 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello175", method = RequestMethod.GET)
  public String sayHello175(@RequestParam(name = "name") String name) {

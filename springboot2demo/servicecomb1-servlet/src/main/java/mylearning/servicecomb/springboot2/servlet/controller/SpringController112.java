...
@RestSchema(schemaId = "springController112")
@RequestMapping(value = "/spring/v0")
public class SpringController112 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello112", method = RequestMethod.GET)
  public String sayHello112(@RequestParam(name = "name") String name) {

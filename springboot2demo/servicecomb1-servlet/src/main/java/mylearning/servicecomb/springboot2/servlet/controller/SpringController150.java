...
@RestSchema(schemaId = "springController150")
@RequestMapping(value = "/spring/v0")
public class SpringController150 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello150", method = RequestMethod.GET)
  public String sayHello150(@RequestParam(name = "name") String name) {

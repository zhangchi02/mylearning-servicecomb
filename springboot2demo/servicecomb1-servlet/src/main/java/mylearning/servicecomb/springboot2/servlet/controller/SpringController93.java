...
@RestSchema(schemaId = "springController93")
@RequestMapping(value = "/spring/v0")
public class SpringController93 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello93", method = RequestMethod.GET)
  public String sayHello93(@RequestParam(name = "name") String name) {

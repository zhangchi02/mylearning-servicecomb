...
@RestSchema(schemaId = "springController21")
@RequestMapping(value = "/spring/v0")
public class SpringController21 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello21", method = RequestMethod.GET)
  public String sayHello21(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController191")
@RequestMapping(value = "/spring/v0")
public class SpringController191 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello191", method = RequestMethod.GET)
  public String sayHello191(@RequestParam(name = "name") String name) {

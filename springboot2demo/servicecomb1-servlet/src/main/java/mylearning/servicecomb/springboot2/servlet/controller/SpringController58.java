...
@RestSchema(schemaId = "springController58")
@RequestMapping(value = "/spring/v0")
public class SpringController58 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello58", method = RequestMethod.GET)
  public String sayHello58(@RequestParam(name = "name") String name) {

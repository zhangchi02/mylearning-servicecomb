...
@RestSchema(schemaId = "springController79")
@RequestMapping(value = "/spring/v0")
public class SpringController79 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello79", method = RequestMethod.GET)
  public String sayHello79(@RequestParam(name = "name") String name) {

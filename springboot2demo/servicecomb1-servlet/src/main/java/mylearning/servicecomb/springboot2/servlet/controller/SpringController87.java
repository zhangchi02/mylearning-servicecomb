...
@RestSchema(schemaId = "springController87")
@RequestMapping(value = "/spring/v0")
public class SpringController87 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello87", method = RequestMethod.GET)
  public String sayHello87(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController33")
@RequestMapping(value = "/spring/v0")
public class SpringController33 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello33", method = RequestMethod.GET)
  public String sayHello33(@RequestParam(name = "name") String name) {

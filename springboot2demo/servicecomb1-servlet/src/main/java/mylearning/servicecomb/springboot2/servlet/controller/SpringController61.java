...
@RestSchema(schemaId = "springController61")
@RequestMapping(value = "/spring/v0")
public class SpringController61 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello61", method = RequestMethod.GET)
  public String sayHello61(@RequestParam(name = "name") String name) {

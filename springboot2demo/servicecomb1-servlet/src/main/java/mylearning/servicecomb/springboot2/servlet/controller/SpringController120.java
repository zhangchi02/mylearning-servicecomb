...
@RestSchema(schemaId = "springController120")
@RequestMapping(value = "/spring/v0")
public class SpringController120 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello120", method = RequestMethod.GET)
  public String sayHello120(@RequestParam(name = "name") String name) {

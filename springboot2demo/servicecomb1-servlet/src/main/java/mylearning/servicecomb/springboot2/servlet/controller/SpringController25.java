...
@RestSchema(schemaId = "springController25")
@RequestMapping(value = "/spring/v0")
public class SpringController25 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello25", method = RequestMethod.GET)
  public String sayHello25(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController135")
@RequestMapping(value = "/spring/v0")
public class SpringController135 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello135", method = RequestMethod.GET)
  public String sayHello135(@RequestParam(name = "name") String name) {

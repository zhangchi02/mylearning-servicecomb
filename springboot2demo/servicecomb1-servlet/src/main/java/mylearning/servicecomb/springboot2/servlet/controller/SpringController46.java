...
@RestSchema(schemaId = "springController46")
@RequestMapping(value = "/spring/v0")
public class SpringController46 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello46", method = RequestMethod.GET)
  public String sayHello46(@RequestParam(name = "name") String name) {

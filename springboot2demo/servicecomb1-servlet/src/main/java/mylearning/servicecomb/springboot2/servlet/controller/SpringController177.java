...
@RestSchema(schemaId = "springController177")
@RequestMapping(value = "/spring/v0")
public class SpringController177 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello177", method = RequestMethod.GET)
  public String sayHello177(@RequestParam(name = "name") String name) {

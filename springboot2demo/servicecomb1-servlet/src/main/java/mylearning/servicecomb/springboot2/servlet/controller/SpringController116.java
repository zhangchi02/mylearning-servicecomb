...
@RestSchema(schemaId = "springController116")
@RequestMapping(value = "/spring/v0")
public class SpringController116 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello116", method = RequestMethod.GET)
  public String sayHello116(@RequestParam(name = "name") String name) {

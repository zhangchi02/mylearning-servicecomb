...
@RestSchema(schemaId = "springController140")
@RequestMapping(value = "/spring/v0")
public class SpringController140 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello140", method = RequestMethod.GET)
  public String sayHello140(@RequestParam(name = "name") String name) {

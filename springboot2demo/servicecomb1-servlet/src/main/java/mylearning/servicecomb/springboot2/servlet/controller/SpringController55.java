...
@RestSchema(schemaId = "springController55")
@RequestMapping(value = "/spring/v0")
public class SpringController55 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello55", method = RequestMethod.GET)
  public String sayHello55(@RequestParam(name = "name") String name) {

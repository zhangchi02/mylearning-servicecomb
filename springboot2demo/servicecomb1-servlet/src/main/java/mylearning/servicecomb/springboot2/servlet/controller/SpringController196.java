...
@RestSchema(schemaId = "springController196")
@RequestMapping(value = "/spring/v0")
public class SpringController196 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello196", method = RequestMethod.GET)
  public String sayHello196(@RequestParam(name = "name") String name) {

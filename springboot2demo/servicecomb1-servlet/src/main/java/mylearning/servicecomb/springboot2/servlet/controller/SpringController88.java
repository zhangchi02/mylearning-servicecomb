...
@RestSchema(schemaId = "springController88")
@RequestMapping(value = "/spring/v0")
public class SpringController88 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello88", method = RequestMethod.GET)
  public String sayHello88(@RequestParam(name = "name") String name) {

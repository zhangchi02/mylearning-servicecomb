...
@RestSchema(schemaId = "springController149")
@RequestMapping(value = "/spring/v0")
public class SpringController149 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello149", method = RequestMethod.GET)
  public String sayHello149(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController62")
@RequestMapping(value = "/spring/v0")
public class SpringController62 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello62", method = RequestMethod.GET)
  public String sayHello62(@RequestParam(name = "name") String name) {

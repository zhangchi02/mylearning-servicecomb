...
@RestSchema(schemaId = "springController197")
@RequestMapping(value = "/spring/v0")
public class SpringController197 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello197", method = RequestMethod.GET)
  public String sayHello197(@RequestParam(name = "name") String name) {

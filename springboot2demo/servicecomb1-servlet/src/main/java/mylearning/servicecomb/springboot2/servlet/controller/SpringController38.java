...
@RestSchema(schemaId = "springController38")
@RequestMapping(value = "/spring/v0")
public class SpringController38 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello38", method = RequestMethod.GET)
  public String sayHello38(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController108")
@RequestMapping(value = "/spring/v0")
public class SpringController108 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello108", method = RequestMethod.GET)
  public String sayHello108(@RequestParam(name = "name") String name) {

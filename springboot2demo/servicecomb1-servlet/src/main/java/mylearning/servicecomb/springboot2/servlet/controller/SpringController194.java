...
@RestSchema(schemaId = "springController194")
@RequestMapping(value = "/spring/v0")
public class SpringController194 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello194", method = RequestMethod.GET)
  public String sayHello194(@RequestParam(name = "name") String name) {

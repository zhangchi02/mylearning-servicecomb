...
@RestSchema(schemaId = "springController74")
@RequestMapping(value = "/spring/v0")
public class SpringController74 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello74", method = RequestMethod.GET)
  public String sayHello74(@RequestParam(name = "name") String name) {

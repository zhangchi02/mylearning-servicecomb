...
@RestSchema(schemaId = "springController169")
@RequestMapping(value = "/spring/v0")
public class SpringController169 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello169", method = RequestMethod.GET)
  public String sayHello169(@RequestParam(name = "name") String name) {

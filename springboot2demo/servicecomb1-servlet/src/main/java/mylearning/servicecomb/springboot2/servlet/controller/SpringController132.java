...
@RestSchema(schemaId = "springController132")
@RequestMapping(value = "/spring/v0")
public class SpringController132 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello132", method = RequestMethod.GET)
  public String sayHello132(@RequestParam(name = "name") String name) {

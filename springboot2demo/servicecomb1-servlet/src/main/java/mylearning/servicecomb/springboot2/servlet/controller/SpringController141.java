...
@RestSchema(schemaId = "springController141")
@RequestMapping(value = "/spring/v0")
public class SpringController141 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello141", method = RequestMethod.GET)
  public String sayHello141(@RequestParam(name = "name") String name) {

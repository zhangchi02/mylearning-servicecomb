...
@RestSchema(schemaId = "springController160")
@RequestMapping(value = "/spring/v0")
public class SpringController160 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello160", method = RequestMethod.GET)
  public String sayHello160(@RequestParam(name = "name") String name) {

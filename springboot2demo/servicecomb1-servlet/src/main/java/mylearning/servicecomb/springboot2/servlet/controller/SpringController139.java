...
@RestSchema(schemaId = "springController139")
@RequestMapping(value = "/spring/v0")
public class SpringController139 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello139", method = RequestMethod.GET)
  public String sayHello139(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController53")
@RequestMapping(value = "/spring/v0")
public class SpringController53 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello53", method = RequestMethod.GET)
  public String sayHello53(@RequestParam(name = "name") String name) {

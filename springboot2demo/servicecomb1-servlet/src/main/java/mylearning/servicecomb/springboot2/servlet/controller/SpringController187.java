...
@RestSchema(schemaId = "springController187")
@RequestMapping(value = "/spring/v0")
public class SpringController187 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello187", method = RequestMethod.GET)
  public String sayHello187(@RequestParam(name = "name") String name) {

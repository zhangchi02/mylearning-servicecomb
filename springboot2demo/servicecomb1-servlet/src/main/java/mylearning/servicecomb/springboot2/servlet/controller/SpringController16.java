...
@RestSchema(schemaId = "springController16")
@RequestMapping(value = "/spring/v0")
public class SpringController16 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello16", method = RequestMethod.GET)
  public String sayHello16(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController98")
@RequestMapping(value = "/spring/v0")
public class SpringController98 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello98", method = RequestMethod.GET)
  public String sayHello98(@RequestParam(name = "name") String name) {

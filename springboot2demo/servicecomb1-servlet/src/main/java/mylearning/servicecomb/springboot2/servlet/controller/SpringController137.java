...
@RestSchema(schemaId = "springController137")
@RequestMapping(value = "/spring/v0")
public class SpringController137 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello137", method = RequestMethod.GET)
  public String sayHello137(@RequestParam(name = "name") String name) {

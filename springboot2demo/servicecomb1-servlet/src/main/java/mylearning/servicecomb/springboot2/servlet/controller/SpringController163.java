...
@RestSchema(schemaId = "springController163")
@RequestMapping(value = "/spring/v0")
public class SpringController163 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello163", method = RequestMethod.GET)
  public String sayHello163(@RequestParam(name = "name") String name) {

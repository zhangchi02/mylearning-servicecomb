...
@RestSchema(schemaId = "springController8")
...
public class SpringController8 {
  ...
  @RequestMapping(value = "/sayHello8", method = RequestMethod.GET)
  public String sayHello8(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController18")
@RequestMapping(value = "/spring/v0")
public class SpringController18 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello18", method = RequestMethod.GET)
  public String sayHello18(@RequestParam(name = "name") String name) {

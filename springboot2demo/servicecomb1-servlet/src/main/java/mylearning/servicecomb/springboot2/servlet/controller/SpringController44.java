...
@RestSchema(schemaId = "springController44")
@RequestMapping(value = "/spring/v0")
public class SpringController44 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello44", method = RequestMethod.GET)
  public String sayHello44(@RequestParam(name = "name") String name) {

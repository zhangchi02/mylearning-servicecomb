...
@RestSchema(schemaId = "springController179")
@RequestMapping(value = "/spring/v0")
public class SpringController179 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello179", method = RequestMethod.GET)
  public String sayHello179(@RequestParam(name = "name") String name) {

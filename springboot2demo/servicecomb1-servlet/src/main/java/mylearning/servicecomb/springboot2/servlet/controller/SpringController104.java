...
@RestSchema(schemaId = "springController104")
@RequestMapping(value = "/spring/v0")
public class SpringController104 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello104", method = RequestMethod.GET)
  public String sayHello104(@RequestParam(name = "name") String name) {

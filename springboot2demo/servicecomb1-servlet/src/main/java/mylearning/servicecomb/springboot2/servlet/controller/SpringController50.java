...
@RestSchema(schemaId = "springController50")
@RequestMapping(value = "/spring/v0")
public class SpringController50 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello50", method = RequestMethod.GET)
  public String sayHello50(@RequestParam(name = "name") String name) {

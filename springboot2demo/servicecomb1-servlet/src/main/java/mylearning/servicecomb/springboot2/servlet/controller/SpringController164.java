...
@RestSchema(schemaId = "springController164")
@RequestMapping(value = "/spring/v0")
public class SpringController164 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello164", method = RequestMethod.GET)
  public String sayHello164(@RequestParam(name = "name") String name) {

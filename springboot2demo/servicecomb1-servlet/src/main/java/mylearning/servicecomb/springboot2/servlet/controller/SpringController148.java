...
@RestSchema(schemaId = "springController148")
@RequestMapping(value = "/spring/v0")
public class SpringController148 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello148", method = RequestMethod.GET)
  public String sayHello148(@RequestParam(name = "name") String name) {

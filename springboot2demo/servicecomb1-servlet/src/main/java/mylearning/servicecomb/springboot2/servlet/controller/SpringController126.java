...
@RestSchema(schemaId = "springController126")
@RequestMapping(value = "/spring/v0")
public class SpringController126 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello126", method = RequestMethod.GET)
  public String sayHello126(@RequestParam(name = "name") String name) {

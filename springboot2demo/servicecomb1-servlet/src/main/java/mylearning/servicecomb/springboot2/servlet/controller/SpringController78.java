...
@RestSchema(schemaId = "springController78")
@RequestMapping(value = "/spring/v0")
public class SpringController78 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello78", method = RequestMethod.GET)
  public String sayHello78(@RequestParam(name = "name") String name) {

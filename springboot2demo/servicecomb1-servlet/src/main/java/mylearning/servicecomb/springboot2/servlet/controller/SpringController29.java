...
@RestSchema(schemaId = "springController29")
@RequestMapping(value = "/spring/v0")
public class SpringController29 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello29", method = RequestMethod.GET)
  public String sayHello29(@RequestParam(name = "name") String name) {

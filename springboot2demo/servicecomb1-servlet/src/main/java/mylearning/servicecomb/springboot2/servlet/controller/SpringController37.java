...
@RestSchema(schemaId = "springController37")
@RequestMapping(value = "/spring/v0")
public class SpringController37 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello37", method = RequestMethod.GET)
  public String sayHello37(@RequestParam(name = "name") String name) {

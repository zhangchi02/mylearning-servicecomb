...
@RestSchema(schemaId = "springController12")
@RequestMapping(value = "/spring/v0")
public class SpringController12 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello12", method = RequestMethod.GET)
  public String sayHello12(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController183")
@RequestMapping(value = "/spring/v0")
public class SpringController183 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello183", method = RequestMethod.GET)
  public String sayHello183(@RequestParam(name = "name") String name) {

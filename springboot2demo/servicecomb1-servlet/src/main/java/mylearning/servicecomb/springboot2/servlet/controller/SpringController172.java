...
@RestSchema(schemaId = "springController172")
@RequestMapping(value = "/spring/v0")
public class SpringController172 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello172", method = RequestMethod.GET)
  public String sayHello172(@RequestParam(name = "name") String name) {

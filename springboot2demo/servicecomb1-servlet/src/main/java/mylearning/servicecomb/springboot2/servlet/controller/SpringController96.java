...
@RestSchema(schemaId = "springController96")
@RequestMapping(value = "/spring/v0")
public class SpringController96 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello96", method = RequestMethod.GET)
  public String sayHello96(@RequestParam(name = "name") String name) {

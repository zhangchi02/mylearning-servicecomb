...
@RestSchema(schemaId = "springController189")
@RequestMapping(value = "/spring/v0")
public class SpringController189 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello189", method = RequestMethod.GET)
  public String sayHello189(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController118")
@RequestMapping(value = "/spring/v0")
public class SpringController118 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello118", method = RequestMethod.GET)
  public String sayHello118(@RequestParam(name = "name") String name) {

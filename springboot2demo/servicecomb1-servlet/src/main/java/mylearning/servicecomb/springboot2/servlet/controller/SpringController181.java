...
@RestSchema(schemaId = "springController181")
@RequestMapping(value = "/spring/v0")
public class SpringController181 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello181", method = RequestMethod.GET)
  public String sayHello181(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController31")
@RequestMapping(value = "/spring/v0")
public class SpringController31 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello31", method = RequestMethod.GET)
  public String sayHello31(@RequestParam(name = "name") String name) {

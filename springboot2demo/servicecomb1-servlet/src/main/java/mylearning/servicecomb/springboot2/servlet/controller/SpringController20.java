...
@RestSchema(schemaId = "springController20")
@RequestMapping(value = "/spring/v0")
public class SpringController20 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello20", method = RequestMethod.GET)
  public String sayHello20(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController65")
@RequestMapping(value = "/spring/v0")
public class SpringController65 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello65", method = RequestMethod.GET)
  public String sayHello65(@RequestParam(name = "name") String name) {

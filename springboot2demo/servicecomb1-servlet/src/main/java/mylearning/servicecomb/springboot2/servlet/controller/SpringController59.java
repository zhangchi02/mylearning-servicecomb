...
@RestSchema(schemaId = "springController59")
@RequestMapping(value = "/spring/v0")
public class SpringController59 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello59", method = RequestMethod.GET)
  public String sayHello59(@RequestParam(name = "name") String name) {

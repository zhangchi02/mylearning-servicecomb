...
@RestSchema(schemaId = "springController24")
@RequestMapping(value = "/spring/v0")
public class SpringController24 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello24", method = RequestMethod.GET)
  public String sayHello24(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController155")
@RequestMapping(value = "/spring/v0")
public class SpringController155 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello155", method = RequestMethod.GET)
  public String sayHello155(@RequestParam(name = "name") String name) {

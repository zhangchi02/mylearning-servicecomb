...
@RestSchema(schemaId = "springController60")
@RequestMapping(value = "/spring/v0")
public class SpringController60 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello60", method = RequestMethod.GET)
  public String sayHello60(@RequestParam(name = "name") String name) {

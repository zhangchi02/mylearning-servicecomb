...
@RestSchema(schemaId = "springController171")
@RequestMapping(value = "/spring/v0")
public class SpringController171 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello171", method = RequestMethod.GET)
  public String sayHello171(@RequestParam(name = "name") String name) {

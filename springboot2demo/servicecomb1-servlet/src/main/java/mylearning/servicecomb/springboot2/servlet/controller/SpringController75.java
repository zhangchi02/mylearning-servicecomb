...
@RestSchema(schemaId = "springController75")
@RequestMapping(value = "/spring/v0")
public class SpringController75 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello75", method = RequestMethod.GET)
  public String sayHello75(@RequestParam(name = "name") String name) {

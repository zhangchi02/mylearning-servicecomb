...
@RestSchema(schemaId = "springController128")
@RequestMapping(value = "/spring/v0")
public class SpringController128 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello128", method = RequestMethod.GET)
  public String sayHello128(@RequestParam(name = "name") String name) {

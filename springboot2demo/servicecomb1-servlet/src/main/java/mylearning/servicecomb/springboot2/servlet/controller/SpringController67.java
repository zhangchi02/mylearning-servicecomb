...
@RestSchema(schemaId = "springController67")
@RequestMapping(value = "/spring/v0")
public class SpringController67 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello67", method = RequestMethod.GET)
  public String sayHello67(@RequestParam(name = "name") String name) {

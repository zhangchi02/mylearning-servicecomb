...
@RestSchema(schemaId = "springController56")
@RequestMapping(value = "/spring/v0")
public class SpringController56 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello56", method = RequestMethod.GET)
  public String sayHello56(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController13")
@RequestMapping(value = "/spring/v0")
public class SpringController13 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello13", method = RequestMethod.GET)
  public String sayHello13(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController69")
@RequestMapping(value = "/spring/v0")
public class SpringController69 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello69", method = RequestMethod.GET)
  public String sayHello69(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController185")
@RequestMapping(value = "/spring/v0")
public class SpringController185 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello185", method = RequestMethod.GET)
  public String sayHello185(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController193")
@RequestMapping(value = "/spring/v0")
public class SpringController193 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello193", method = RequestMethod.GET)
  public String sayHello193(@RequestParam(name = "name") String name) {

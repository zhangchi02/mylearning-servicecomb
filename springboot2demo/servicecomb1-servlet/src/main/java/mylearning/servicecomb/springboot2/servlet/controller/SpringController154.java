...
@RestSchema(schemaId = "springController154")
@RequestMapping(value = "/spring/v0")
public class SpringController154 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello154", method = RequestMethod.GET)
  public String sayHello154(@RequestParam(name = "name") String name) {

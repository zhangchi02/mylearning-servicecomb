...
@RestSchema(schemaId = "springController6")
...
public class SpringController6 {
  ...
  @RequestMapping(value = "/sayHello6", method = RequestMethod.GET)
  public String sayHello6(@RequestParam(name = "name") String name) {

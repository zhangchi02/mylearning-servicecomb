...
@RestSchema(schemaId = "springController99")
@RequestMapping(value = "/spring/v0")
public class SpringController99 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello99", method = RequestMethod.GET)
  public String sayHello99(@RequestParam(name = "name") String name) {

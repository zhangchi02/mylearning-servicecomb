...
@RestSchema(schemaId = "springController85")
@RequestMapping(value = "/spring/v0")
public class SpringController85 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello85", method = RequestMethod.GET)
  public String sayHello85(@RequestParam(name = "name") String name) {

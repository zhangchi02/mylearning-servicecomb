...
@RestSchema(schemaId = "springController34")
@RequestMapping(value = "/spring/v0")
public class SpringController34 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello34", method = RequestMethod.GET)
  public String sayHello34(@RequestParam(name = "name") String name) {

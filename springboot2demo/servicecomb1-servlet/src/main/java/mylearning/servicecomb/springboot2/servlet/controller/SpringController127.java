...
@RestSchema(schemaId = "springController127")
@RequestMapping(value = "/spring/v0")
public class SpringController127 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello127", method = RequestMethod.GET)
  public String sayHello127(@RequestParam(name = "name") String name) {

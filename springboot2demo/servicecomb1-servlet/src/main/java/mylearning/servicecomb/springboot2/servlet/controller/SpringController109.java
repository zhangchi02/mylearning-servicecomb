...
@RestSchema(schemaId = "springController109")
@RequestMapping(value = "/spring/v0")
public class SpringController109 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello109", method = RequestMethod.GET)
  public String sayHello109(@RequestParam(name = "name") String name) {

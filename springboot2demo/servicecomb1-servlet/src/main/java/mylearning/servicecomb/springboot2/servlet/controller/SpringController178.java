...
@RestSchema(schemaId = "springController178")
@RequestMapping(value = "/spring/v0")
public class SpringController178 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello178", method = RequestMethod.GET)
  public String sayHello178(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController47")
@RequestMapping(value = "/spring/v0")
public class SpringController47 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello47", method = RequestMethod.GET)
  public String sayHello47(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController176")
@RequestMapping(value = "/spring/v0")
public class SpringController176 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello176", method = RequestMethod.GET)
  public String sayHello176(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController157")
@RequestMapping(value = "/spring/v0")
public class SpringController157 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello157", method = RequestMethod.GET)
  public String sayHello157(@RequestParam(name = "name") String name) {

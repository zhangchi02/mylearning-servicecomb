...
@RestSchema(schemaId = "springController73")
@RequestMapping(value = "/spring/v0")
public class SpringController73 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello73", method = RequestMethod.GET)
  public String sayHello73(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController106")
@RequestMapping(value = "/spring/v0")
public class SpringController106 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello106", method = RequestMethod.GET)
  public String sayHello106(@RequestParam(name = "name") String name) {

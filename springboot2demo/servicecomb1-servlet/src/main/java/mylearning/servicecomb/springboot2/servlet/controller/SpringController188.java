...
@RestSchema(schemaId = "springController188")
@RequestMapping(value = "/spring/v0")
public class SpringController188 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello188", method = RequestMethod.GET)
  public String sayHello188(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController115")
@RequestMapping(value = "/spring/v0")
public class SpringController115 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello115", method = RequestMethod.GET)
  public String sayHello115(@RequestParam(name = "name") String name) {

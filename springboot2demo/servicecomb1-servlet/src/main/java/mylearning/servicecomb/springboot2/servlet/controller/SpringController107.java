...
@RestSchema(schemaId = "springController107")
@RequestMapping(value = "/spring/v0")
public class SpringController107 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello107", method = RequestMethod.GET)
  public String sayHello107(@RequestParam(name = "name") String name) {

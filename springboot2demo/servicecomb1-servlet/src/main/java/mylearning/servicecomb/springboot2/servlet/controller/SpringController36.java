...
@RestSchema(schemaId = "springController36")
@RequestMapping(value = "/spring/v0")
public class SpringController36 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello36", method = RequestMethod.GET)
  public String sayHello36(@RequestParam(name = "name") String name) {

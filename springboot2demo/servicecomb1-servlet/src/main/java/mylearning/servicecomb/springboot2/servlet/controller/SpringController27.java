...
@RestSchema(schemaId = "springController27")
@RequestMapping(value = "/spring/v0")
public class SpringController27 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello27", method = RequestMethod.GET)
  public String sayHello27(@RequestParam(name = "name") String name) {

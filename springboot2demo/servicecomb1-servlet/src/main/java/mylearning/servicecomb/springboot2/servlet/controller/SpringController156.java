...
@RestSchema(schemaId = "springController156")
@RequestMapping(value = "/spring/v0")
public class SpringController156 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello156", method = RequestMethod.GET)
  public String sayHello156(@RequestParam(name = "name") String name) {

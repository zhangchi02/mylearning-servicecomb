...
@RestSchema(schemaId = "springController146")
@RequestMapping(value = "/spring/v0")
public class SpringController146 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello146", method = RequestMethod.GET)
  public String sayHello146(@RequestParam(name = "name") String name) {

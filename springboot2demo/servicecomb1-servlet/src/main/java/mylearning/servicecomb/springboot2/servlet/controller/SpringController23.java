...
@RestSchema(schemaId = "springController23")
@RequestMapping(value = "/spring/v0")
public class SpringController23 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello23", method = RequestMethod.GET)
  public String sayHello23(@RequestParam(name = "name") String name) {

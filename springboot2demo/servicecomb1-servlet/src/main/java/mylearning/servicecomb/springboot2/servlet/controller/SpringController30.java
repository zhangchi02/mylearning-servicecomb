...
@RestSchema(schemaId = "springController30")
@RequestMapping(value = "/spring/v0")
public class SpringController30 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello30", method = RequestMethod.GET)
  public String sayHello30(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController129")
@RequestMapping(value = "/spring/v0")
public class SpringController129 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello129", method = RequestMethod.GET)
  public String sayHello129(@RequestParam(name = "name") String name) {

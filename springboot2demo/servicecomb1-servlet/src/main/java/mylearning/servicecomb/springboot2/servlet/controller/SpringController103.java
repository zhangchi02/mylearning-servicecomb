...
@RestSchema(schemaId = "springController103")
@RequestMapping(value = "/spring/v0")
public class SpringController103 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello103", method = RequestMethod.GET)
  public String sayHello103(@RequestParam(name = "name") String name) {

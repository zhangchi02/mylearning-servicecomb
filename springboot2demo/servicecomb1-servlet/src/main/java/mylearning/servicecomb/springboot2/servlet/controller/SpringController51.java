...
@RestSchema(schemaId = "springController51")
@RequestMapping(value = "/spring/v0")
public class SpringController51 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello51", method = RequestMethod.GET)
  public String sayHello51(@RequestParam(name = "name") String name) {

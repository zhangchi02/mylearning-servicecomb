...
@RestSchema(schemaId = "springController114")
@RequestMapping(value = "/spring/v0")
public class SpringController114 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello114", method = RequestMethod.GET)
  public String sayHell0114(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController63")
@RequestMapping(value = "/spring/v0")
public class SpringController63 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello63", method = RequestMethod.GET)
  public String sayHello63(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController9")
...
public class SpringController9 {
  ...
  @RequestMapping(value = "/sayHello9", method = RequestMethod.GET)
  public String sayHello9(@RequestParam(name = "name") String name) {

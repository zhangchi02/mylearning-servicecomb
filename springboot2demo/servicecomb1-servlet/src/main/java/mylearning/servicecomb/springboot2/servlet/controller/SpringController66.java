...
@RestSchema(schemaId = "springController66")
@RequestMapping(value = "/spring/v0")
public class SpringController66 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello66", method = RequestMethod.GET)
  public String sayHello66(@RequestParam(name = "name") String name) {

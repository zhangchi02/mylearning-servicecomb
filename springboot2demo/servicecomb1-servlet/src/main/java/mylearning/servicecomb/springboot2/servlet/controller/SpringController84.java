...
@RestSchema(schemaId = "springController84")
@RequestMapping(value = "/spring/v0")
public class SpringController84 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello84", method = RequestMethod.GET)
  public String sayHello84(@RequestParam(name = "name") String name) {

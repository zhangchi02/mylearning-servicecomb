...
@RestSchema(schemaId = "springController92")
@RequestMapping(value = "/spring/v0")
public class SpringController92 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello92", method = RequestMethod.GET)
  public String sayHello92(@RequestParam(name = "name") String name) {

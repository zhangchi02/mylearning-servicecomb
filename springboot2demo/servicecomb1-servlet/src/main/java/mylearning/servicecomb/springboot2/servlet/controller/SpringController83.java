...
@RestSchema(schemaId = "springController83")
@RequestMapping(value = "/spring/v0")
public class SpringController83 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello83", method = RequestMethod.GET)
  public String sayHello83(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController124")
@RequestMapping(value = "/spring/v0")
public class SpringController124 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello124", method = RequestMethod.GET)
  public String sayHello124(@RequestParam(name = "name") String name) {

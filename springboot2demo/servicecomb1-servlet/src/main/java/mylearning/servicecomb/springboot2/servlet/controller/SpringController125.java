...
@RestSchema(schemaId = "springController125")
@RequestMapping(value = "/spring/v0")
public class SpringController125 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello125", method = RequestMethod.GET)
  public String sayHello125(@RequestParam(name = "name") String name) {

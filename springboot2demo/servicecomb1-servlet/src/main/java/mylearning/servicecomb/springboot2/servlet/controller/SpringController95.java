...
@RestSchema(schemaId = "springController95")
@RequestMapping(value = "/spring/v0")
public class SpringController95 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello95", method = RequestMethod.GET)
  public String sayHello95(@RequestParam(name = "name") String name) {

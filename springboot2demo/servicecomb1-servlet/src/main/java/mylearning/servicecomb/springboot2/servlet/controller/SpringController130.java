...
@RestSchema(schemaId = "springController130")
@RequestMapping(value = "/spring/v0")
public class SpringController130 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello130", method = RequestMethod.GET)
  public String sayHello130(@RequestParam(name = "name") String name) {

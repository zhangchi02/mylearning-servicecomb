...
@RestSchema(schemaId = "springController145")
@RequestMapping(value = "/spring/v0")
public class SpringController145 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello145", method = RequestMethod.GET)
  public String sayHello145(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController71")
@RequestMapping(value = "/spring/v0")
public class SpringController71 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello71", method = RequestMethod.GET)
  public String sayHello71(@RequestParam(name = "name") String name) {

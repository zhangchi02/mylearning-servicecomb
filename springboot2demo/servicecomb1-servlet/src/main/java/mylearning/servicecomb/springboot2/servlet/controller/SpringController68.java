...
@RestSchema(schemaId = "springController68")
@RequestMapping(value = "/spring/v0")
public class SpringController68 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello68", method = RequestMethod.GET)
  public String sayHello68(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController97")
@RequestMapping(value = "/spring/v0")
public class SpringController97 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello97", method = RequestMethod.GET)
  public String sayHello97(@RequestParam(name = "name") String name) {

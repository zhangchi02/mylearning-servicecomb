...
@RestSchema(schemaId = "springController138")
@RequestMapping(value = "/spring/v0")
public class SpringController138 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello138", method = RequestMethod.GET)
  public String sayHello138(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController105")
@RequestMapping(value = "/spring/v0")
public class SpringController105 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello105", method = RequestMethod.GET)
  public String sayHello105(@RequestParam(name = "name") String name) {

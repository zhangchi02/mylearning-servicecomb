...
@RestSchema(schemaId = "springController144")
@RequestMapping(value = "/spring/v0")
public class SpringController144 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello144", method = RequestMethod.GET)
  public String sayHello144(@RequestParam(name = "name") String name) {

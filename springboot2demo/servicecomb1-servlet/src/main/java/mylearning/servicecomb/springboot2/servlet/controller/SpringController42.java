...
@RestSchema(schemaId = "springController42")
@RequestMapping(value = "/spring/v0")
public class SpringController42 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello42", method = RequestMethod.GET)
  public String sayHello42(@RequestParam(name = "name") String name) {

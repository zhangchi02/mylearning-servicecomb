...
@RestSchema(schemaId = "springController151")
@RequestMapping(value = "/spring/v0")
public class SpringController151 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello151", method = RequestMethod.GET)
  public String sayHello151(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController165")
@RequestMapping(value = "/spring/v0")
public class SpringController165 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello165", method = RequestMethod.GET)
  public String sayHello165(@RequestParam(name = "name") String name) {

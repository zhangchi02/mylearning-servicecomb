...
@RestSchema(schemaId = "springController158")
@RequestMapping(value = "/spring/v0")
public class SpringController158 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello158", method = RequestMethod.GET)
  public String sayHello158(@RequestParam(name = "name") String name) {

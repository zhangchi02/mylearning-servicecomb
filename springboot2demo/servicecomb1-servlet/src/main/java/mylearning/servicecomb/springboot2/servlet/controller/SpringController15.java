...
@RestSchema(schemaId = "springController15")
@RequestMapping(value = "/spring/v0")
public class SpringController15 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello15", method = RequestMethod.GET)
  public String sayHello15(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController86")
@RequestMapping(value = "/spring/v0")
public class SpringController86 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello86", method = RequestMethod.GET)
  public String sayHello86(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController173")
@RequestMapping(value = "/spring/v0")
public class SpringController173 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello173", method = RequestMethod.GET)
  public String sayHello173(@RequestParam(name = "name") String name) {

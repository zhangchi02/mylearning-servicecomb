...
@RestSchema(schemaId = "springController80")
@RequestMapping(value = "/spring/v0")
public class SpringController80 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello80", method = RequestMethod.GET)
  public String sayHello80(@RequestParam(name = "name") String name) {

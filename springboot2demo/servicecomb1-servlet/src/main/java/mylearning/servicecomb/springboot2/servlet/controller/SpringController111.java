...
@RestSchema(schemaId = "springController111")
@RequestMapping(value = "/spring/v0")
public class SpringController111 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHell0111", method = RequestMethod.GET)
  public String sayHello111(@RequestParam(name = "name") String name) {

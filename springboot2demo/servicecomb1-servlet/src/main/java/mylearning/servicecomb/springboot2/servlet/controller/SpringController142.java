...
@RestSchema(schemaId = "springController142")
@RequestMapping(value = "/spring/v0")
public class SpringController142 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello142", method = RequestMethod.GET)
  public String sayHello142(@RequestParam(name = "name") String name) {

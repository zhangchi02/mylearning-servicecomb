...
@RestSchema(schemaId = "springController48")
@RequestMapping(value = "/spring/v0")
public class SpringController48 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello48", method = RequestMethod.GET)
  public String sayHello48(@RequestParam(name = "name") String name) {

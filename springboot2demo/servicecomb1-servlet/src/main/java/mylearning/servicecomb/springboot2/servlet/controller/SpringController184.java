...
@RestSchema(schemaId = "springController184")
@RequestMapping(value = "/spring/v0")
public class SpringController184 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello184", method = RequestMethod.GET)
  public String sayHello184(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController19")
@RequestMapping(value = "/spring/v0")
public class SpringController19 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello19", method = RequestMethod.GET)
  public String sayHello19(@RequestParam(name = "name") String name) {

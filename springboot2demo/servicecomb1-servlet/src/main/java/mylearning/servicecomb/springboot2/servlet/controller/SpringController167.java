...
@RestSchema(schemaId = "springController167")
@RequestMapping(value = "/spring/v0")
public class SpringController167 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello167", method = RequestMethod.GET)
  public String sayHello167(@RequestParam(name = "name") String name) {

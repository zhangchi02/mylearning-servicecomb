...
@RestSchema(schemaId = "springController77")
@RequestMapping(value = "/spring/v0")
public class SpringController77 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello77", method = RequestMethod.GET)
  public String sayHello77(@RequestParam(name = "name") String name) {

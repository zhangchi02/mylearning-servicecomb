...
@RestSchema(schemaId = "springController161")
@RequestMapping(value = "/spring/v0")
public class SpringController161 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello161", method = RequestMethod.GET)
  public String sayHello161(@RequestParam(name = "name") String name) {

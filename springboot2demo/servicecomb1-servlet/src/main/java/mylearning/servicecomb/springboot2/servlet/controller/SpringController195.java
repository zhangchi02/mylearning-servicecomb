...
@RestSchema(schemaId = "springController195")
@RequestMapping(value = "/spring/v0")
public class SpringController195 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello195", method = RequestMethod.GET)
  public String sayHello195(@RequestParam(name = "name") String name) {

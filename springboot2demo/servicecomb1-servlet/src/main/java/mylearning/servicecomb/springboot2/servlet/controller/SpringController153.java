...
@RestSchema(schemaId = "springController153")
@RequestMapping(value = "/spring/v0")
public class SpringController153 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello153", method = RequestMethod.GET)
  public String sayHello153(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController17")
@RequestMapping(value = "/spring/v0")
public class SpringController17 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello17", method = RequestMethod.GET)
  public String sayHello17(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController28")
@RequestMapping(value = "/spring/v0")
public class SpringController28 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello28", method = RequestMethod.GET)
  public String sayHello28(@RequestParam(name = "name") String name) {

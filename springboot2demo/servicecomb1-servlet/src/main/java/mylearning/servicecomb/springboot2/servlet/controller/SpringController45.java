...
@RestSchema(schemaId = "springController45")
@RequestMapping(value = "/spring/v0")
public class SpringController45 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello45", method = RequestMethod.GET)
  public String sayHello45(@RequestParam(name = "name") String name) {

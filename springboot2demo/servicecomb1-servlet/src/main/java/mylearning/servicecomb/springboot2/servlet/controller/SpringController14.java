...
@RestSchema(schemaId = "springController14")
@RequestMapping(value = "/spring/v0")
public class SpringController14 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello14", method = RequestMethod.GET)
  public String sayHell014(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController182")
@RequestMapping(value = "/spring/v0")
public class SpringController182 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello182", method = RequestMethod.GET)
  public String sayHello182(@RequestParam(name = "name") String name) {

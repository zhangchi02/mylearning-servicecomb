...
@RestSchema(schemaId = "springController11")
...
public class SpringController11 {
  ...
  @RequestMapping(value = "/sayHell011", method = RequestMethod.GET)
  public String sayHello11(@RequestParam(name = "name") String name) {

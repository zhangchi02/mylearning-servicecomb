...
@RestSchema(schemaId = "springController162")
@RequestMapping(value = "/spring/v0")
public class SpringController162 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello162", method = RequestMethod.GET)
  public String sayHello162(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController7")
...
public class SpringController7 {
  ...
  @RequestMapping(value = "/sayHello7", method = RequestMethod.GET)
  public String sayHello7(@RequestParam(name = "name") String name) {

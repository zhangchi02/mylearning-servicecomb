...
@RestSchema(schemaId = "springController40")
@RequestMapping(value = "/spring/v0")
public class SpringController40 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello40", method = RequestMethod.GET)
  public String sayHello40(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController35")
@RequestMapping(value = "/spring/v0")
public class SpringController35 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello35", method = RequestMethod.GET)
  public String sayHello35(@RequestParam(name = "name") String name) {

...
@RestSchema(schemaId = "springController81")
@RequestMapping(value = "/spring/v0")
public class SpringController81 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello81", method = RequestMethod.GET)
  public String sayHello81(@RequestParam(name = "name") String name) {

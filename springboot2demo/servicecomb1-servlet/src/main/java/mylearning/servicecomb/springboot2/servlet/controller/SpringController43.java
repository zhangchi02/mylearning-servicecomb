...
@RestSchema(schemaId = "springController43")
@RequestMapping(value = "/spring/v0")
public class SpringController43 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello43", method = RequestMethod.GET)
  public String sayHello43(@RequestParam(name = "name") String name) {

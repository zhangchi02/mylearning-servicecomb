...
@RestSchema(schemaId = "springController91")
@RequestMapping(value = "/spring/v0")
public class SpringController91 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello91", method = RequestMethod.GET)
  public String sayHello91(@RequestParam(name = "name") String name) {

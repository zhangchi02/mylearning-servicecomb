...
@RestSchema(schemaId = "springController110")
@RequestMapping(value = "/spring/v0")
public class SpringController110 {
  private static final Logger LOG = LoggerFactory.getLogger(SpringController.class);

  @RequestMapping(value = "/sayHello110", method = RequestMethod.GET)
  public String sayHello110(@RequestParam(name = "name") String name) {

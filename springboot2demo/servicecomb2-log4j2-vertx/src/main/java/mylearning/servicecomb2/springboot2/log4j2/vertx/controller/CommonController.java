...
@RequestMapping(path = "/servicecomb2log4j2vertx/v0")
public class CommonController {
  ...
  @RequestMapping(value = {"/{project_id}/datasources"}, produces = {"application/json"}, method = {RequestMethod.POST})
  public ResponseEntity<String> createDatasource(@Valid @NotNull @PathVariable("project_id") String projectId,
      @Valid @RequestBody String datasourceDTO,
      @Valid @NotNull @RequestHeader(value = "X-Auth-Token", name = "X-Auth-Token", required = true) String xAuthToken)
      throws Exception {

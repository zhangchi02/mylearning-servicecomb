package mylearning.servicecomb2.springboot2.log4j2.vertx.handler;
...
public class ProviderHandler implements Handler {
  ...
  @Autowired
  public ProviderHandler(String method){
    LOGGER.info("ProviderHandler is build.");
  }
  ...
  public void init(MicroserviceMeta microserviceMeta, InvocationType invocationType) {
    LOGGER.info("ProviderHandler.init is invoked.");
  }

...
public class DemoFilter implements HttpServerFilter {
  ...
  public Response afterReceiveRequest(Invocation invocation, HttpServletRequestEx httpServletRequestEx) {
    String remoteAddr = httpServletRequestEx.getRemoteAddr();
    String remoteHost = httpServletRequestEx.getRemoteHost();
    LOG.info("DemoFilter afterReceiveRequest.");
    LOG.info("DemoFilter afterReceiveRequest remoteAddr:{}.", remoteAddr);
    LOG.info("DemoFilter afterReceiveRequest remoteHost:{}.", remoteHost);
    //从请求中取出一个header
    ...
    if ("provider.cookieService.login".equalsIgnoreCase(operationName)) {

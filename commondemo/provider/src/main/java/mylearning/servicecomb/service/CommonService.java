...
public class CommonService implements ICommonService {
  ...
  private DynamicLongProperty helloDelay = DynamicPropertyFactory.getInstance().getLongProperty("delay.sayHello2", 0);
  ...
  public String listPerson(@RequestBody List<Person> persons) {
  ...
  public Teacher queryTeacher(@RequestBody @Valid Teacher teacher) {
  ...
  @RequestMapping(path = "/queryObject", method = RequestMethod.GET)
  public String queryObject(Person person) {
    return "Hi," + person;
  }
}

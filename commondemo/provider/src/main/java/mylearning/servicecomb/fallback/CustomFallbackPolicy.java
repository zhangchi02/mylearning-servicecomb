package mylearning.servicecomb.fallback;
...
public class CustomFallbackPolicy implements FallbackPolicy {
  ...
  public Response getFallbackResponse(Invocation invocation, Throwable error) {
    CommonExceptionData errorData = new CommonExceptionData("CustomFallbackPolicy errorMsg");
    InvocationException exception = ExceptionFactory.createProducerException(errorData);

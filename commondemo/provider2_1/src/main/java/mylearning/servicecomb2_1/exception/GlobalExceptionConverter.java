...
public class GlobalExceptionConverter implements ExceptionToProducerResponseConverter<Exception> {
  ...
  public Response convert(SwaggerInvocation swaggerInvocation, Exception exception) {
    LOG.info("GlobalExceptionConverter.convert is invoked.");
...
//        return "provider ArithmeticException convert.";
//      }
//    };
...
//    return Response.failResp(state);
    InvocationException invocationException = new InvocationException(490, "provider global exception reasonPhrase","errorData");

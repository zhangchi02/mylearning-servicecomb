...
public class ConnectionRateResponseVo {
  ...
  public ConnectionRateResponseVo() {
  }

  public ConnectionRateResponseVo(Date selectStartTime, Date selectEndTime, String startTime, Long timeLength,
      Long precision) {
